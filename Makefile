...
MODULES_NAME        = DirectedGraph ResourceNode Request StringCache Cache HourFilter AbstractFilter
MODULES_NAME_TEST   = DirectedGraph ResourceNode Request StringCache Cache HourFilter AbstractFilter
